...
import {LayoutDashboard,PlusCircle,FileText,User,Wallet,Users,Shield,Sparkles,} from "lucide-react";
...
name:"Analytics",
icon:Wallet,
href:"/dashboard/creator/creator-analytics",
},
],
...
className={active?"flex items-center gap-2 px-5 py-3 rounded-2xl whitespace-nowrap bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-xl transition-all duration-300":"flex items-center gap-2 px-5 py-3 rounded-2xl whitespace-nowrap glass-card border border-border hover:border-emerald-500/40 transition-all duration-300"}
